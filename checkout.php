   ...
   <form action="" method="POST">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="number" name="number" placeholder="enter your number" min="0" max="9999999999" placeholder="03234987654" onkeypress="if(this.value.length == 11) return false;" class="box" required>
         </div>
         <div class="inputBox">
